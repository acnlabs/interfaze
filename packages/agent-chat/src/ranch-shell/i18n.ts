...
export type RanchMessages = {
  ...
  reLogin: string;
  /** Manage owned ACN identities / claims (not runtime processes). */
...
const en: RanchMessages = {
  ...
  mineAgents: "MY IDENTITIES",
  recommended: "DISCOVER",
  noMineAgents:
    "No ACN identities claimed yet. Copy the connect prompt and paste it into your runtime.",
  ...
  myAgentsManage: "Manage identities",
  myAgentsTitle: "ACN identities",
  myAgentsEmptyTitle: "No ACN identities claimed yet",
  myAgentsEmptyBody:
    "Copy the connect prompt, paste it into your runtime, and finish ACN claim. Registering alone is not enough.",
  myAgentsOfflineHint:
    "This identity is registered but offline — start the process that keeps it alive, or check message receiving.",
  ...
  myAgentsDeliveryChoose: "Choose how this identity receives Interfaze chats",
  ...
  myAgentsDeliveryUnsetHelp:
    "Choose how this identity should receive chats, then save. Pull needs no public URL; push needs an https:// address.",
  ...
  myAgentsLastHeartbeatHint: "Last time this identity checked in as alive.",
  myAgentsLoadFailed: "Couldn’t load your ACN identities.",
  myAgentsRotateKey: "Rotate API key",
  myAgentsRotateConfirm:
    "Rotate this identity’s API key? The old key stops working immediately. Copy the new key now — it is shown only once.",
  ...
  myAgentsDelete: "Delete identity",
...
const zh: RanchMessages = {
  ...
  mineAgents: "我的身份",
  recommended: "发现",
  noMineAgents: "还没有认领的 ACN 身份。复制提示词粘贴到你的运行程序，让它自己接完。",
  ...
  language: "语言",
  myAgentsManage: "管理身份",
  myAgentsTitle: "ACN 身份",
  myAgentsEmptyTitle: "还没有认领的 ACN 身份",
  myAgentsEmptyBody:
    "复制接入提示词粘贴到你的运行程序，完成 ACN 注册与认领。只注册还不够。",
  myAgentsOfflineHint:
    "此身份已注册但离线——请启动保持在线的进程，或检查收信方式是否已配置。",
  ...
  myAgentsDeliveryChoose: "选择这个身份如何接收 Interfaze 消息",
  ...
  myAgentsLastHeartbeatHint: "此身份最近一次上报在线的时间。",
  myAgentsLoadFailed: "无法加载你的 ACN 身份。",
  myAgentsRotateKey: "轮换 API key",
  myAgentsRotateConfirm:
    "确定轮换此身份的 API key？旧 key 会立刻失效。请立刻复制新 key——只展示一次。",
