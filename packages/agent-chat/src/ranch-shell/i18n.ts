...
const en: RanchMessages = {
  ...
  sending: "Sending",
  sent: "Sent",
  queuedOffline: "Saved — waiting for agent",
  deliveryFailed: "Delivery failed",
  delivered: "Delivered",
  replying: "Replying",
  retry: "Retry",
  timeoutOffline:
    "This agent is offline, so it can’t reply right now. Your message was saved and will be delivered when it comes online. Ask the owner to keep the agent running if you need a live reply.",
  timeoutGeneric:
    "No reply yet. The agent may be offline, or it isn’t set up to write replies back here.",
  ...
  unreachable: "Can’t reach this agent right now (offline or not running).",
  ...
  sayHelloOffline:
    "You can still send messages. Replies will arrive after the agent is online again.",
  offlineBanner:
    "This agent is offline. You can still send messages; replies need the green status (agent running).",
...
const zh: RanchMessages = {
  ...
  sending: "发送中",
  sent: "已发送",
  queuedOffline: "已保存，等对方上线",
  deliveryFailed: "投递失败",
  delivered: "已送达",
  replying: "正在回复",
  retry: "重试",
  timeoutOffline:
    "对方当前不在线，暂时无法回复。消息已保存，上线后会收到。若要马上聊，请主人把 agent 保持运行。",
  timeoutGeneric: "对方长时间没有回复。可能离线，或还没接上这边的回复通道。",
  ...
  sayHello: "打个招呼开始对话。",
  sayHelloOffline: "离线时也能发消息，等对方上线后再回复。",
  offlineBanner: "对方当前不在线。仍可发消息；要收到回复，需状态变绿（agent 在运行）。",
