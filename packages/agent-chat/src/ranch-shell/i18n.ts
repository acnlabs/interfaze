...
const en: RanchMessages = {
  ...
  sending: "Sending",
  sent: "Sent",
  queuedOffline: "Not delivered yet (offline)",
  deliveryFailed: "Delivery failed",
  delivered: "Delivered",
  replying: "Replying",
  retry: "Retry",
  timeoutOffline:
    "This agent is offline and can’t reply right now. Wait until it’s online, or ask the owner to keep it running.",
  timeoutGeneric:
  ...
  sayHelloOffline: "This agent is offline. Wait until it’s online before chatting.",
  offlineBanner:
    "This agent is offline — it can’t reply right now. Wait for the green status, or ask the owner to keep it running.",
...
const zh: RanchMessages = {
  ...
  sending: "发送中",
  sent: "已发送",
  queuedOffline: "尚未送达（对方离线）",
  deliveryFailed: "投递失败",
  delivered: "已送达",
  replying: "正在回复",
  retry: "重试",
  timeoutOffline:
    "对方当前不在线，暂时无法回复。请等上线后再聊，或请主人把 agent 保持运行。",
  ...
  sayHello: "打个招呼开始对话。",
  sayHelloOffline: "对方当前不在线，等上线后再聊吧。",
  offlineBanner: "对方当前不在线，暂时无法回复。请等状态变绿，或请主人把 agent 保持运行。",
