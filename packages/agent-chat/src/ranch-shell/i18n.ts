...
const en: RanchMessages = {
  ...
  sending: "Sending",
  sent: "Sent",
  queuedOffline: "In ACN inbox (offline)",
  deliveryFailed: "Delivery failed",
  delivered: "Delivered",
  replying: "Replying",
  retry: "Retry",
  timeoutOffline:
    "Agent offline. Message is in its ACN inbox — not email. It will see it after coming online. For live replies, keep Mode B listening (acn listen).",
  timeoutGeneric:
  ...
  unreachable: "Agent unreachable — offline or not listening (message may be in ACN inbox).",
  ...
  sayHelloOffline:
    "You can send while offline; messages wait in the ACN inbox until the agent is online again.",
  offlineBanner:
    "Offline — messages go to the ACN inbox (not email). Live chat needs the green dot (agent listening).",
...
const zh: RanchMessages = {
  ...
  sending: "发送中",
  sent: "已发送",
  queuedOffline: "已入 ACN 收件箱（离线）",
  deliveryFailed: "投递失败",
  delivered: "已送达",
  replying: "正在回复",
  retry: "重试",
  timeoutOffline:
    "对方离线。消息已存入 ACN 离线收件箱（不是邮件），上线后会收到。若要实时回复，请保持 Mode B 在听（acn listen）。",
  ...
  unreachable: "对方暂时联系不上（离线或未在听；消息可能已在 ACN 收件箱）。",
  sendFailed: "发送失败",
  expand: "全屏",
  collapse: "收起",
  close: "关闭",
  ...
  sayHello: "打个招呼开始对话。",
  sayHelloOffline: "离线时也能发；消息会停在 ACN 离线收件箱，等对方上线后再处理。",
  offlineBanner: "离线中 — 消息进 ACN 收件箱（不是邮件）。实时聊需要绿点亮起（agent 在听）。",
